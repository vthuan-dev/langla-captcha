@echo off
echo ===== Khởi động lại Langla-Duky với Spaced Captcha Processing =====
echo.
...
echo Đang build dự án với Spaced Captcha Processing...
dotnet build
echo.
...
echo Khởi động ứng dụng với Spaced Captcha Processing...
...
echo  ✅ 10 phương pháp OCR khác nhau:
...
echo     7. OCR với xử lý màu sắc chuyên biệt
echo     8. OCR với grayscale và threshold tự động
echo     9. OCR đặc biệt cho captcha có khoảng trắng ⭐ MỚI
echo    10. OCR với xử lý màu sắc từng ký tự riêng biệt ⭐ MỚI
echo  ✅ Spaced Captcha Processing:
echo     - Xử lý captcha có khoảng trắng như "e u m f"
echo     - Tăng độ tương phản giữa text và background
echo     - Tách biệt từng ký tự theo màu sắc
echo     - Cấu hình Tesseract đặc biệt cho captcha có khoảng trắng
...
echo  4. Thử 10 phương pháp OCR khác nhau
...
echo  - captcha_color_processed_[timestamp].jpg - Ảnh xử lý màu sắc
echo  - captcha_grayscale_[timestamp].jpg - Ảnh grayscale threshold
echo  - captcha_spaced_[timestamp].jpg - Ảnh xử lý khoảng trắng ⭐ MỚI
echo  - captcha_char_separated_[timestamp].jpg - Ảnh tách ký tự ⭐ MỚI
...
echo  6. Đặc biệt chú ý file captcha_spaced và captcha_char_separated
echo.
echo Phương pháp mới sẽ xử lý:
echo  - Captcha có khoảng trắng như "e u m f"
echo  - Captcha có màu sắc khác nhau cho từng ký tự
echo  - Captcha có độ tương phản kém
echo  - Captcha có nhiều màu sắc phức tạp
echo.
